/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e29ec8a563458c9bf92485f02cf449b2)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		__DEV__: "false";
		NEXT_INC_CACHE_R2_PREFIX: "incremental-cache-staging";
		NEXTJS_ENV: string;
		RPC_URLS: string;
		WORKER_URLS: string;
		PRIVATE_KEY: string;
	...
	interface Env {
		...
		ASSETS: Fetcher;
		__DEV__: "false";
		NEXT_INC_CACHE_R2_PREFIX: "incremental-cache-staging" | "incremental-cache";
		NEXTJS_ENV: string;
		RPC_URLS: string;
		WORKER_URLS: string;
		PRIVATE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "__DEV__" | "NEXT_INC_CACHE_R2_PREFIX" | "NEXTJS_ENV" | "RPC_URLS" | "WORKER_URLS" | "PRIVATE_KEY" | "REPRESENTATIVE" | "ADMIN_TOKEN" | "DEBUG" | "HCAPTCHA_SECRET">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 15cb6474b0575f9049c5e1615d43d748)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "NanoDropDO" | "CoinMarketCapDO";
	}
	interface StagingEnv {
		...
		NEXT_PUBLIC_DONATION_ADDRESS: string;
		...
		COINMARKETCAP_DO: DurableObjectNamespace<import("./worker").CoinMarketCapDO>;
